...
define('QUIZHUD_WWW_ROOT', 'http://vps63850.ovh.net/quizhud'); // The URL to your quiz HUD installation
define('QUIZHUD_DIR_ROOT', '/var/www/quizhud'); // The absolute path on disk to your quiz HUD installation

// Administration password (use this to login through your web-browser when you want to edit stuff)
define('QUIZHUD_ADMIN_PWD','edmondo');
// Internal password for requests coming from SL (PUT YOUR OWN RANDOM PASSWORD HERE)
define('QUIZHUD_INTERNAL_PWD', '9045');
